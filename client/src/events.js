...
// fired when players wants to go back to main menu
export const TO_MAIN_MENU = 'TO_MAIN_MENU';

// fired when player wants to start a game
export const NEW_GAME = 'NEW_GAME';

// fired when player wants to relogin
export const REPEAT_LOGIN = 'REPEAT_LOGIN';